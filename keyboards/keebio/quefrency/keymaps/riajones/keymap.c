...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_65_with_macro(
    ...
    KC_F7,   KC_F8,   KC_LCTL, KC_LGUI, KC_LALT, MO(MOUS),KC_SPC,           _______, KC_ENT,  MO(MDIA),MO(MOUS),CTL_APP, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [MDIA] = LAYOUT_65_with_macro(
    ...
    TD_TBCP, TD_TBOS, RGB_TOG, _______, KC_UP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    TD_GITH, _______, KC_TILD, _______, _______, _______, _______,          _______, _______, _______, _______, _______, KC_MPRV, KC_VOLD, KC_MNXT
  ),
