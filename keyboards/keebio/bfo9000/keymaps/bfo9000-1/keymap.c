...
[BASE] = LAYOUT(
  TD(ESC_LT), KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,      KC_F7,       KC_F8,         CU_GHUB,    CU_GMAL,    CU_YTUB,    KC_WAKE,  KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_DEL,
  KC_GRV,     KC_1,    KC_2,    KC_3,     KC_4,    KC_5,    KC_6,       KC_VOLD,     KC_VOLU,       LIN_SNL,    LIN_SNR,    KC_7,       KC_8,     KC_9,    KC_0,    KC_MINS, KC_EQUAL, KC_BSPC,
  KC_TAB,     KC_Q,    KC_W,    KC_E,     KC_R,    KC_T,    KC_LBRC,    DB_STRT,     PLAY,          KC_PGUP,    TD(TD_TBCP),KC_RBRC,    KC_Y,     KC_U,    KC_I,    KC_O,    KC_P,     KC_BSLS,
  KC_LCTL,    KC_A,    KC_S,    KC_D,     KC_F,    KC_G,    DB_PLAY,    DB_STEP,     DB_IN,         KC_PGDN,    CU_TBOS,    CU_TMUX,    KC_H,     KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
