...
[BASE] = LAYOUT(
  TD(ESC_LT), KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,      KC_F7,       KC_F8,         TD(GITHUB), CU_GMAL,    CU_YTUB,    KC_WAKE,  KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_DEL,
  ...
  KC_LCTL,    KC_A,    KC_S,    KC_D,     KC_F,    KC_G,    DB_PLAY,    DB_STEP,     DB_IN,         KC_PGDN,    TD(TB_OSS), CU_TMUX,    KC_H,     KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
