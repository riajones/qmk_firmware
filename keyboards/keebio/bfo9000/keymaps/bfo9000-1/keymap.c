...
[BASE] = LAYOUT(
  ...
  KC_GRV,     KC_1,    KC_2,    KC_3,     KC_4,     KC_5,   KC_6,    KC_7,    KC_8,          _______,  KC_9,    KC_0,    KC_MINS, KC_PLUS,  _______, _______, KC_BSPC, KC_BSPC,
  ...
  KC_LCTL,    KC_LGUI, KC_LALT, MO(MDIA), SPC_MOUS, KC_SPC, KC_ENT,  VU,      GITHUB,        _______,  KC_ENT,  KC_ENT,  KC_RGUI, MO(MDIA), MO(MDIA),KC_LEFT, KC_DOWN, KC_RIGHT
),
