...
[BASE] = LAYOUT(
  ...
  KC_LCTL,    KC_A,    KC_S,    KC_D,     KC_F,        KC_G,   KC_F2,   KC_F12,  KC_HOME,       KC_PGDN,   LIN_SNL,  LIN_SNR,    KC_H,    KC_J,   KC_K,    KC_L,    KC_SCLN,  KC_QUOT,
  ...
  KC_LCTL,    KC_LGUI, KC_LALT, MO(MDIA), CU_SPC_MOUS, KC_SPC, KC_ENT,  CU_KVM,  KC_DEL,        SS_LINU,   MO(MOUS), CU_ENT_MED, KC_ENT,  KC_ENT, CTL_APP, KC_LEFT, KC_DOWN,  KC_RGHT
),

[OSX] = LAYOUT(
  _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______, _______, OSX_WSU, _______, _______, _______, _______, _______, _______,
  KC_LGUI, _______, _______, _______, _______, _______, _______, _______, _______,     _______, OSX_SNL, OSX_SNR, _______, _______, _______, _______, _______, _______,
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______,     SS_OSX,  _______, _______, _______, _______, _______, _______, _______, _______
),
...
[MDIA] = LAYOUT(
  ...
  _______, _______, _______, _______,  _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, PLAY,    _______, KC_VOLD, _______
),
