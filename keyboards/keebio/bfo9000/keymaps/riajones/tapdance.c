...
typedef enum { TD_NONE, TD_UNKNOWN, TD_SINGLE_TAP, TD_SINGLE_TAP_HOLD, TD_DOUBLE_TAP, TD_DOUBLE_TAP_HOLD } td_state_t;
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [ESC_LT] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, esclt_finished, esclt_reset), [CMD_SHIFT] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, cmd_shift_finished, cmd_shift_reset), [HM_WSL] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, hm_wsl_finished, hm_wsl_reset), [END_WSR] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, end_wsr_finished, end_wsr_reset), [TB_TBCP] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, tb_corp_finished, tb_corp_reset), [TB_OSS] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, tb_oss_finished, tb_oss_reset), [GITHUB] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, github_finished, github_reset),
};
