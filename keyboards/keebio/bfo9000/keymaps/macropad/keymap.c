...
[BASE] = LAYOUT(
  ...
  KC_SLEP,  _______,  _______, _______, _______, OBS_SC1, CU_SNPL, CU_SNPR, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
  CU_SCRN,  _______,  CU_GHUB, CU_GMAL, CU_YTUB, OBS_SC2, CU_WSPL, CU_WSPR, CU_DASH,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
  CU_TERM,  _______,  _______, OBS_STR, OBS_STP, OBS_SC3, DB_STRT, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,
